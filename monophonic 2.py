...
def wave_to_midi(audio_signal: np.array, srate: int = 22050, frame_length: int = 2048, hop_length: int = 512,
                ...
                min_note_duration: float = 0.22) -> midiutil.MIDIFile():
...
if __name__ == "__main__":
    ...
    data_folder = '/Users/emmang/Desktop/data mining - IS424/project/converting-acapella-songs-to-sheet-music/data'
    process_wav_files(data_folder)
